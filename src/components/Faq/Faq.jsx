...
<div class="accordion-item">
 ...
 return(
  <div class="accordion-item">
  <h1 class="accordion-header rounded" id={item.flushID}>
    <button class="accordion-button fs-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target={item.flushCollapsTarget} aria-expanded="false" aria-controls={item.flushCollaps}>
    {item.title}
    </button>
  </h1>
  <div id={item.flushCollaps} class="accordion-collapse collapse" aria-labelledby={item.flushID} data-bs-parent="#accordionFlushExample">
    <div class="accordion-body">
      <p>
      {item.desc}
      </p>

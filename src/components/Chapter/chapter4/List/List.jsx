...
const List = () => {
  return (
        ...
        <p>‘type’ অ্যাট্রিবিউট ব্যবহার করে আমরা এইসব চিহ্ন প্রদর্শন করতে পারবো। ‘type’ অ্যাট্রিবিউট এর ভ্যালু ‘disc’ , ‘cycle’ এবং ‘square’ লিখলে যথাক্রমে চাকতি, বৃত্তাকার ও বর্গাকার চিহ্ন প্রদর্শন করবে।</p>
